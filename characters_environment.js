...
// Activación de vaiable noseX con el modelo de poseNet
...
function manualControl(character) {
  ...
  if (character.live) {
    // Activación de la nariz para moverse a la izquierda
    if (noseX < 300) {
      character.velocity.x -= gameConfig.moveSpeed;
      character.changeAnimation('move');
      character.mirrorX(-1);
    ...
    // Activación de la nariz para moverse a la derecha
    if (noseX > 300) {
      character.velocity.x += gameConfig.moveSpeed;
      character.changeAnimation('move');
      character.mirrorX(1);
...
// Se usa la posición Y de 0 a la 167 de la posición de la nariz
